...
../main: ${OBJECTFILES}
	${MKDIR} -p ..
	${LINK.cc} -o ../main ${OBJECTFILES} ${LDLIBSOPTIONS} -I/home/vb/include -L/home/vb/lib -lsdsl -ldivsufsort -ldivsufsort64

${OBJECTDIR}/_ext/75fcdad/malloc_count.o: ../external/malloc_count/malloc_count.c
	${MKDIR} -p ${OBJECTDIR}/_ext/75fcdad
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/75fcdad/malloc_count.o ../external/malloc_count/malloc_count.c
